...
def _starts_above_level(ordinal: Ordinal, level: Ordinal) -> bool:
    return bool(ordinal.terms) and _cmp_ordinal(ordinal.terms[0][0].level, level) > 0
...
class EBOCFOrdinalEncoder:
    ...
    def prime_table_admissible_raw_codes(self) -> list[int]:
        return list(self._admissible_index(ZERO).admissible_raw_codes)
